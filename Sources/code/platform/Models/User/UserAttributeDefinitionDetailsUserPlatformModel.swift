...
public extension PlatformClient.ApplicationClient.User {
    ...
    */
    ...
    class UserAttributeDefinitionDetails: Codable {
        ...
        public init(applicationId: String? = nil, createdAt: String? = nil, createdBy: String? = nil, customerEditable: Bool? = nil, description: String? = nil, encrypted: Bool? = nil, icon: String? = nil, isLocked: Bool? = nil, isMultiValue: Bool? = nil, masking: AttributeMaskingProperties? = nil, modifiedAt: String? = nil, name: String? = nil, orderingChannels: [String]? = nil, pinned: Bool? = nil, pinOrder: Int? = nil, registration: AttributeRegistrationProperties? = nil, slug: String? = nil, type: String? = nil, updatedBy: String? = nil, validations: [UserAttributeDefinitionValidation]? = nil, id: String? = nil) {
