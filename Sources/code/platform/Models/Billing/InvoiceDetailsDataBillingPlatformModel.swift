...
public extension PlatformClient.Billing {
    ...
    */
    ...
    class InvoiceDetailsData: Codable {
        ...
        public init(attemp: Double? = nil, attempt: Double? = nil, autoAdvance: Bool? = nil, client: Client? = nil, collectionMethod: String? = nil, createdAt: String? = nil, creditBalance: Double? = nil, creditNoteAmount: Double? = nil, currency: String? = nil, currentStatus: String? = nil, discount: [String: Any]? = nil, documents: [String: Any]? = nil, invoiceType: String? = nil, invoiceUrl: String? = nil, modifiedAt: String? = nil, nextActionTime: String? = nil, number: String? = nil, oldSettlement: Double? = nil, paid: Bool? = nil, payment: [String: Any]? = nil, period: Period? = nil, pgData: [String: Any]? = nil, receiptNumber: String? = nil, statementDescriptor: String? = nil, statusTrail: [StatusTrail]? = nil, subscriberId: String? = nil, subscription: String? = nil, subtotal: Double? = nil, taxation: [String: Any]? = nil, total: Double? = nil, id: String? = nil) {
