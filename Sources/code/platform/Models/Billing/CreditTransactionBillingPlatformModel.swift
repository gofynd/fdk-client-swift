...
public extension PlatformClient.Billing {
    ...
    */
    ...
    class CreditTransaction: Codable {
        ...
        public init(amount: Int? = nil, author: Author? = nil, createdAt: String? = nil, currency: String? = nil, description: String? = nil, endingBalance: EndingBalance? = nil, entity: [String: Any]? = nil, isTest: String? = nil, modifiedAt: String? = nil, payment: PaymentData? = nil, subscriberId: String? = nil, type: String? = nil, id: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    isTest = try container.decode(String.self, forKey: .isTest)
