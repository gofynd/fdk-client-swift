...
public extension PlatformClient.Billing {
    ...
    */
    ...
    class ChargeDetails: Codable {
        ...
        public init(activatedOn: String? = nil, billingDate: String? = nil, cancelledOn: String? = nil, cappedAmount: Double? = nil, chargeType: String? = nil, companyId: String? = nil, createdAt: String? = nil, currentPeriod: SubscriptionTrialPeriod? = nil, entityId: String? = nil, entityType: String? = nil, isTest: Bool? = nil, meta: [String: Any]? = nil, modifiedAt: String? = nil, name: String? = nil, price: EntityChargePrice? = nil, pricingType: String? = nil, recurring: ChargeRecurring? = nil, status: String? = nil, term: String? = nil, id: String? = nil, v: Double? = nil) {
