...
public extension PlatformClient.Billing {
    ...
    */
    ...
    class InvoicesData: Codable {
        ...
        public init(attemp: Int? = nil, autoAdvance: Bool? = nil, client: InvoicesDataClient? = nil, collectionMethod: String? = nil, createdAt: String? = nil, creditBalance: Double? = nil, creditNoteAmount: Double? = nil, currency: String? = nil, currentStatus: String? = nil, discount: [String: Any]? = nil, documents: [String: Any]? = nil, hashIdentifier: String? = nil, invoiceItems: [InvoiceItems]? = nil, invoiceType: String? = nil, invoiceUrl: String? = nil, modifiedAt: String? = nil, nextActionTime: String? = nil, number: String? = nil, oldSettlement: Double? = nil, paid: Bool? = nil, payment: [String: Any]? = nil, paymentMethod: InvoicesDataPaymentMethod? = nil, period: InvoicesDataPeriod? = nil, pgData: [String: Any]? = nil, receiptNumber: String? = nil, statementDescriptor: String? = nil, statusTrail: [InvoiceDetailsStatusTrail]? = nil, subscriberId: String? = nil, subscription: String? = nil, subtotal: Double? = nil, taxation: [String: Any]? = nil, total: Double? = nil, id: String? = nil) {
