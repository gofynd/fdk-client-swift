...
public extension PlatformClient.Billing {
    ...
    */
    ...
    class SetupPayment: Codable {
        ...
        public init(clientSecret: String? = nil, customer: String? = nil, id: String? = nil, mandate: String? = nil, paymentMethod: String? = nil, paymentMethodOptions: PaymentMethodOptions? = nil, status: String? = nil) {
