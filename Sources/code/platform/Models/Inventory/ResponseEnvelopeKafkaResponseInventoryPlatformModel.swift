...
public extension PlatformClient.Inventory {
    ...
    class ResponseEnvelopeKafkaResponse: Codable {
        ...
        public var items: KafkaResponse?

        public var payload: KafkaResponse?
        ...
        public init(error: String? = nil, exception: String? = nil, httpStatus: String? = nil, items: KafkaResponse? = nil, message: String? = nil, page: Page? = nil, payload: KafkaResponse? = nil, status: Int? = nil, timestamp: String? = nil, totalTimeTakenInMillis: Int? = nil, traceId: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                items = try container.decode(KafkaResponse.self, forKey: .items)
            ...
            do {
                payload = try container.decode(KafkaResponse.self, forKey: .payload)
