...
public extension PlatformClient.Theme {
    ...
    */
    ...
    class CompanyTheme: Codable {
        ...
        public init(companyId: Int? = nil, createdAt: String? = nil, marketplaceThemeId: String? = nil, meta: CompanyThemeMeta? = nil, name: String? = nil, updatedAt: String? = nil, id: String? = nil) {
