...
public extension PlatformClient.Theme {
    ...
    class AllThemesApplicationResponseV2: Codable {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                assets = try container.decode(AssetsV2.self, forKey: .assets)
