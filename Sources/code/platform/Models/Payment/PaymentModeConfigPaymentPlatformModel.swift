...
public extension PlatformClient.Payment {
    ...
    */
    ...
    class PaymentModeConfig: Codable {
        ...
        public var items: [PaymentModeItems]?
        ...
        public init(businessUnit: String? = nil, device: String? = nil, isActive: Bool? = nil, items: [PaymentModeItems]? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    items = try container.decode([PaymentModeItems].self, forKey: .items)
