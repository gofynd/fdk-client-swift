...
public extension PlatformClient.Payment {
    ...
    */
    ...
    class GetPaymentSessionResponse: Codable {
        ...
        public var refundDetails: [String]?
        ...
        public init(appliedPaymentOffers: AppliedOfferSerializer? = nil, checksum: String? = nil, currency: String, gid: String, meta: [String: Any]? = nil, paymentDetails: PaymentSessionDetail, refundDetails: [String]? = nil, status: String, totalAmount: Int) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    refundDetails = try container.decode([String].self, forKey: .refundDetails)
