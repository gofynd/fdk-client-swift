...
public extension PlatformClient.Payment {
    ...
    */
    ...
    class GetPaymentSessionResponse: Codable {
        ...
        public init(appliedPaymentOffers: AppliedOfferSerializer? = nil, cartDetails: CartDetailsSerializer? = nil, checksum: String? = nil, currency: String, gid: String, meta: [String: Any]? = nil, paymentDetails: PaymentSessionDetail, refundDetails: [RefundDetailsSerializer]? = nil, status: String, totalAmount: Int) {
