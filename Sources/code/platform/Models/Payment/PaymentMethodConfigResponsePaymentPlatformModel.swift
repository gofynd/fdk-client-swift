...
public extension PlatformClient.Payment {
    ...
    */
    ...
    class PaymentMethodConfigResponse: Codable {
        ...
        public init(autoCapture: [Bool]? = nil, checkoutType: [CheckoutType]? = nil, country: [Country]? = nil, currency: [Currency]? = nil, mode: [Mode]? = nil, paymentMethods: [PaymentMode]? = nil, requiredSessionPaths: [RequiredSessionPath]? = nil, success: Bool? = nil) {
