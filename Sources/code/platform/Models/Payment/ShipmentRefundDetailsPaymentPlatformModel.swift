...
public extension PlatformClient.Payment {
    ...
    */
    ...
    class ShipmentRefundDetails: Codable {
        ...
        public var meta: ShipmentRefundDetailsMeta?
        ...
        public init(beneficiaryId: String? = nil, meta: ShipmentRefundDetailsMeta? = nil, orderId: String, shipmentIds: [String]? = nil, transferMode: String) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    meta = try container.decode(ShipmentRefundDetailsMeta.self, forKey: .meta)
