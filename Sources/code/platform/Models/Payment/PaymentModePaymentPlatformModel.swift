...
public extension PlatformClient.Payment {
    ...
    */
    ...
    class PaymentMode: Codable {
        ...
        public init(code: String? = nil, displayName: String? = nil, id: Int? = nil, isActive: Bool? = nil, logos: PaymentModeLogo? = nil, name: String? = nil, priority: Int? = nil, slug: String? = nil, subPaymentMode: [SubPaymentMode]? = nil) {
