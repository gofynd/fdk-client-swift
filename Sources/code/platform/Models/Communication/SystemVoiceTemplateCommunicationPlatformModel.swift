...
public extension PlatformClient.Communication {
    ...
    class SystemVoiceTemplate: Codable {
        ...
        public var message: VoiceTemplateMessage?
        ...
        public init(createdAt: String? = nil, description: String? = nil, isInternal: Bool? = nil, isSystem: Bool? = nil, message: VoiceTemplateMessage? = nil, name: String? = nil, priority: String? = nil, published: Bool? = nil, slug: String? = nil, tags: [[String: Any]]? = nil, templateVariables: [String: Any]? = nil, updatedAt: String? = nil, id: String? = nil, v: Int? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                message = try container.decode(VoiceTemplateMessage.self, forKey: .message)
