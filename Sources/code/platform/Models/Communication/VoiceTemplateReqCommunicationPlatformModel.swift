...
public extension PlatformClient.Communication {
    ...
    class VoiceTemplateReq: Codable {
        ...
        public init(attachments: [[String: Any]]? = nil, description: String? = nil, message: VoiceTemplateMessage? = nil, name: String? = nil, priority: String? = nil, templateVariables: [String: Any]? = nil) {
            self.name = name
