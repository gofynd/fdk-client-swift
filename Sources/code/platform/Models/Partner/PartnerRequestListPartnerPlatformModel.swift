...
public extension PlatformClient.Partner {
    ...
    */
    ...
    class PartnerRequestList: Codable {
        
        
        public var items: PartnerList?
        ...
        public init(items: PartnerList? = nil, page: Pagination? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    items = try container.decode(PartnerList.self, forKey: .items)
