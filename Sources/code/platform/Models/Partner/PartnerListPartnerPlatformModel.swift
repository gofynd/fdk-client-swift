...
public extension PlatformClient.Partner {
    ...
    class PartnerList: Codable {
        ...
        public init(accountType: String? = nil, approvedPermissions: ApprovedPermissionsInfo? = nil, approverId: String? = nil, comment: String? = nil, companyId: Double? = nil, companyName: String? = nil, createdAt: String? = nil, modifiedAt: String? = nil, organizationId: String? = nil, organizationName: String? = nil, requestedPermissions: RequestedPermissions? = nil, requestStatus: String? = nil, userId: String? = nil, id: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                approverId = try container.decode(String.self, forKey: .approverId)
