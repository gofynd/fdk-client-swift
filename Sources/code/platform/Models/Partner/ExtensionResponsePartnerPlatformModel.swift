...
public extension PlatformClient.Partner {
    ...
    class ExtensionResponse: Codable {
        public var items: [ExtensionListItems]?
        ...
        public init(items: [ExtensionListItems]? = nil, page: Pagination? = nil) {
            self.items = items
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                items = try container.decode([ExtensionListItems].self, forKey: .items)
