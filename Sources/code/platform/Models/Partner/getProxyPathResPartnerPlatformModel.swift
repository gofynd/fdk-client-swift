...
public extension PlatformClient.Partner {
    ...
    class getProxyPathRes: Codable {
        public var page: Pagination?

        public var items: [AddProxyResponse]?
        ...
        public init(items: [AddProxyResponse]? = nil, page: Pagination? = nil) {
            self.page = page
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                items = try container.decode([AddProxyResponse].self, forKey: .items)
