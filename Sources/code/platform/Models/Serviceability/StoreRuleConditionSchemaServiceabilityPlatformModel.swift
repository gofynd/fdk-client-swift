...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class StoreRuleConditionSchema: Codable {
        ...
        public init(brandIds: IntComparisonOperations? = nil, categoryIds: IntComparisonOperations? = nil, customerRadius: CustomerRadiusSchema? = nil, departmentIds: IntComparisonOperations? = nil, orderPlaceDate: ArithmeticOperationsV2? = nil, productIds: IntComparisonOperations? = nil, productTags: StringComparisonOperations? = nil, storeTags: StringComparisonOperations? = nil, storeType: StringComparisonOperations? = nil, toLocation: LocationRule? = nil, zoneIds: StringComparisonOperations? = nil) {
