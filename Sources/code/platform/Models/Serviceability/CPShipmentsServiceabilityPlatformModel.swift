...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class CPShipments: Codable {
        ...
        public init(articles: [ShipmentsArticles]? = nil, courierPartnerSchemes: [String]? = nil, id: String? = nil, locationId: Double? = nil, locationTags: [String]? = nil, locationType: String? = nil, shipmentCost: Double? = nil, shipmentDimension: ShipmentDimension? = nil, shipmentVolumetricWeight: Double? = nil, shipmentWeight: Double? = nil) {
