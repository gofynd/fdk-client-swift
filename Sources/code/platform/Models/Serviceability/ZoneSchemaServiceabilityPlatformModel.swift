...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class ZoneSchema: Codable {
        ...
        public init(applicationId: [String: Any], companyId: [String: Any], createdBy: CreatedBy? = nil, createdOn: String, geoAreas: [String: Any], isActive: [String: Any], modifiedBy: ModifiedBy? = nil, modifiedOn: String, name: [String: Any], product: [String: Any], slug: [String: Any], stage: [String: Any], stores: [String: Any], zoneId: [String: Any]) {
