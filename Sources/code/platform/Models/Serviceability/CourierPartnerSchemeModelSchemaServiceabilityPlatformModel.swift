...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class CourierPartnerSchemeModelSchema: Codable {
        ...
        public init(companyId: String? = nil, createdBy: CreatedBy? = nil, createdOn: String? = nil, defaultCutoffTimezone: String? = nil, defaultForwardPickupCutoff: String? = nil, defaultReversePickupCutoff: String? = nil, defaultTat: CourierPartnerSchemeDefaultTat? = nil, deliveryType: String, extensionId: String? = nil, feature: CourierPartnerSchemeFeatures, modifiedBy: ModifiedBy? = nil, modifiedOn: String? = nil, name: String, ndrAttempts: Int? = nil, nonQcShipmentItemQuantity: Int? = nil, paymentMode: [String], qcShipmentItemQuantity: Int? = nil, region: String, schemeId: String? = nil, stage: String, statusUpdates: String? = nil, transportType: String, volumetricWeight: ArithmeticOperations? = nil, weight: ArithmeticOperations) {
