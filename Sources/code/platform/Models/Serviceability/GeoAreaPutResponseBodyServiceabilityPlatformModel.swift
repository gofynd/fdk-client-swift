...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class GeoAreaPutResponseBody: Codable {
        ...
        public init(areas: [Area]? = nil, createdBy: String? = nil, createdOn: String? = nil, geoareaId: String? = nil, isActive: Bool? = nil, modifiedBy: String? = nil, modifiedOn: String? = nil, name: String? = nil, regionType: String? = nil, slug: String? = nil, type: String? = nil) {
