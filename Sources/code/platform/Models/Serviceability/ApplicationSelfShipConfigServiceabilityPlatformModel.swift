...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class ApplicationSelfShipConfig: Codable {
        ...
        public var selfShip: SelfShipResponseSchema?
        ...
        public init(selfShip: SelfShipResponseSchema? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    selfShip = try container.decode(SelfShipResponseSchema.self, forKey: .selfShip)
