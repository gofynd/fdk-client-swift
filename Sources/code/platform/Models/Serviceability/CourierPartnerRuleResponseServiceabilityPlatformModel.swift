...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class CourierPartnerRuleResponse: Codable {
        ...
        public init(conditions: CourierPartnerRuleResponseConditions, cpList: [CourierPartnerList]? = nil, isActive: Bool, manualPriority: [String]? = nil, name: String, sort: [String], type: String) {
