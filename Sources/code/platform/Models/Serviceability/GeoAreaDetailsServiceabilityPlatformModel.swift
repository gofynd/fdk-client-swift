...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class GeoAreaDetails: Codable {
        ...
        public init(applicationId: String? = nil, areas: [AreaExpanded], companyId: Int? = nil, createdBy: CreatedBy? = nil, createdOn: String? = nil, geoareaId: String, isActive: Bool, modifiedBy: ModifiedBy? = nil, modifiedOn: String? = nil, name: String, regionType: String? = nil, slug: String, type: String) {
