...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class CourierPartnerRuleResponseDetailSchema: Codable {
        ...
        public var conditions: CourierPartnerRuleResponseDetailConditions
        ...
        public init(applicationId: String? = nil, companyId: Int? = nil, conditions: CourierPartnerRuleResponseDetailConditions, cpList: [CourierPartnerList]? = nil, id: String? = nil, isActive: Bool, manualPriority: [String]? = nil, name: String, shipmentAdjustmentType: String? = nil, sort: [String], type: String) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                conditions = try container.decode(CourierPartnerRuleResponseDetailConditions.self, forKey: .conditions)
