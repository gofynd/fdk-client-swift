...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class CourierPartnerRuleResponseSchema: Codable {
        ...
        public init(applicationId: String? = nil, companyId: Int? = nil, conditions: CourierPartnerRuleResponseConditions, cpList: [CourierPartnerList]? = nil, id: String? = nil, isActive: Bool, manualPriority: [String]? = nil, name: String, shipmentAdjustmentType: String? = nil, sort: [String], type: String) {
