...
public extension PlatformClient.Serviceability {
    ...
    */
    ...
    class PincodeMOPResult: Codable {
        ...
        public var updatedPincodes: [PincodeMopUpdateResult]?
        ...
        public init(action: String, batchId: String, country: String, pincodes: [Int]? = nil, statusCode: Int, success: Bool, updatedPincodes: [PincodeMopUpdateResult]? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    updatedPincodes = try container.decode([PincodeMopUpdateResult].self, forKey: .updatedPincodes)
