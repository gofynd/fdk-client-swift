...
public extension PlatformClient.Order {
    ...
    */
    ...
    class RuleRequest: Codable {
        ...
        public init(actions: RuleAction, channel: String, conditions: [Condition], description: String? = nil, entityType: String, flowType: String, isActive: Bool, isDeleted: Bool, meta: RuleMeta, name: String, qcEnabled: Bool, restrictForwardServiceability: Bool? = nil, ruleType: String, value: String) {
