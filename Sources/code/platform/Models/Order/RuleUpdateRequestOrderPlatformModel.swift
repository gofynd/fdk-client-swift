...
public extension PlatformClient.Order {
    ...
    */
    ...
    class RuleUpdateRequest: Codable {
        ...
        public init(actions: RuleAction, channel: String, conditions: [Condition], description: String? = nil, entityType: String, flowType: String, isActive: Bool, isDeleted: Bool, meta: RuleMeta, name: String, position: Int, qcEnabled: Bool, restrictForwardServicability: Bool, ruleType: String, value: String) {
