...
public extension PlatformClient.Order {
    ...
    class ShipmentMeta: Codable {
        ...
        public var creditNoteData: CreditNoteData?
        ...
        public enum CodingKeys: String, CodingKey {
            ...
            case creditNoteData = "credit_note_data"
        ...
        public init(assignDpFromSb: Bool? = nil, autoTriggerDpAssignmentAcf: Bool? = nil, awbNumber: String? = nil, b2BBuyerDetails: BuyerDetails? = nil, b2CBuyerDetails: [String: Any]? = nil, bagWeight: [String: Any]? = nil, boxType: String? = nil, creditNoteData: CreditNoteData? = nil, debugInfo: DebugInfo? = nil, dimension: Dimensions? = nil, dpId: String? = nil, dpName: String? = nil, dpOptions: [String: Any]? = nil, dpSortKey: String? = nil, dueDate: String? = nil, einvoiceInfo: EinvoiceInfo? = nil, ewaybillInfo: [String: Any]? = nil, externalLink: [String: Any]? = nil, formatted: Formatted? = nil, forwardAffiliateOrderId: String? = nil, forwardAffiliateShipmentId: String? = nil, fulfilmentPriorityText: String? = nil, lockData: LockData? = nil, marketplaceStoreId: String? = nil, orderType: String? = nil, packagingName: String? = nil, parentDpId: String? = nil, poNumber: String? = nil, refundTo: String? = nil, returnAffiliateOrderId: String? = nil, returnAffiliateShipmentId: String? = nil, returnAwbNumber: String? = nil, returnDetails: [String: Any]? = nil, returnStoreNode: Int? = nil, sameStoreAvailable: Bool, shipmentTags: [ShipmentTags]? = nil, shipmentVolumetricWeight: Double? = nil, shipmentWeight: Double? = nil, storeInvoiceUpdatedDate: String? = nil, timestamp: ShipmentTimeStamp? = nil, weight: Int) {
            ...
            self.creditNoteData = creditNoteData
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                creditNoteData = try container.decode(CreditNoteData.self, forKey: .creditNoteData)
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            try? container.encodeIfPresent(creditNoteData, forKey: .creditNoteData)
