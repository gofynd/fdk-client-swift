...
public extension PlatformClient.Order {
    ...
    */
    ...
    class DynamicChargeSchema: Codable {
        ...
        public init(amount: AmountSchema, code: String? = nil, distributionLogic: DistributionLogicSchema? = nil, meta: [String: Any]? = nil, name: String, taxes: DynamicChargeTaxSchema? = nil, type: String) {
