...
public extension PlatformClient.Order {
    ...
    */
    ...
    class Config: Codable {
        ...
        public init(application: ConfigApplication? = nil, dpConfiguration: ConfigDpConfiguration? = nil, integrationType: [String: Any]? = nil, locationReassignment: Bool? = nil, lockStates: [String]? = nil, orderingChannelLogo: String? = nil, payment: ConfigPayment) {
