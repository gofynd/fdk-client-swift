...
public extension PlatformClient.Order {
    ...
    class PlatformItem: Codable {
        ...
        public init(attributes: PlatformArticleAttributes? = nil, brand: String? = nil, canCancel: Bool? = nil, canReturn: Bool? = nil, code: String? = nil, color: String? = nil, departmentId: Int? = nil, id: Int? = nil, image: [String]? = nil, images: [String]? = nil, l1Category: [String]? = nil, l3Category: Int? = nil, l3CategoryName: String? = nil, name: String? = nil, size: String? = nil) {
            self.images = images
