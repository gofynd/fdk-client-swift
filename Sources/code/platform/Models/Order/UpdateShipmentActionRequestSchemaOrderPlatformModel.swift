...
public extension PlatformClient.Order {
    ...
    */
    ...
    class UpdateShipmentActionRequestSchema: Codable {
        
        
        public var forceTransition: Bool?
        
        public var statuses: [RequestActionSchema]?
        ...
        public init(forceTransition: Bool? = nil, lockAfterTransition: Bool? = nil, statuses: [RequestActionSchema]? = nil, task: Bool? = nil, unlockBeforeTransition: Bool? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    statuses = try container.decode([RequestActionSchema].self, forKey: .statuses)
