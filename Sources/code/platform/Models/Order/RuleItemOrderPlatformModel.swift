...
public extension PlatformClient.Order {
    ...
    */
    ...
    class RuleItem: Codable {
        ...
        public init(actions: RuleAction, channel: String, conditions: Condition, description: String, entityType: String, flowType: String, id: String, isActive: Bool, isDeleted: Bool, meta: Meta, name: String, position: Int, qcEnabled: Bool, ruleType: String, value: String) {
