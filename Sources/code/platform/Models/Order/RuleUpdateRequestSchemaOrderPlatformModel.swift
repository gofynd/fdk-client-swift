...
public extension PlatformClient.Order {
    ...
    */
    ...
    class RuleUpdateRequestSchema: Codable {
        ...
        public init(actions: RuleAction, channel: String, conditions: [Condition], description: String? = nil, entityType: String, flowType: String, isActive: Bool, isDeleted: Bool, meta: RuleMeta, name: String, position: Int, qcEnabled: Bool, restrictForwardServiceability: Bool, ruleType: String, value: String) {
