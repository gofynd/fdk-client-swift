...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class CreateAppPriceFactoryProductExportJobResponse: Codable {
        ...
        public init(applicationId: String? = nil, companyId: Int? = nil, createdBy: CreatedBy? = nil, createdOn: String? = nil, factoryId: String? = nil, failedRecords: Int? = nil, fileType: String? = nil, isActive: Bool? = nil, jobType: String? = nil, modifiedBy: CreatedBy? = nil, modifiedOn: String? = nil, stage: String? = nil, successRecords: Int? = nil, totalRecords: Int? = nil, id: String? = nil) {
