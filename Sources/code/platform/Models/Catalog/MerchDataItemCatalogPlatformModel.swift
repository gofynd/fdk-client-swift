...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class MerchDataItem: Codable {
        ...
        public init(action: [String]? = nil, applicationId: String? = nil, isActive: Bool? = nil, merchandisingRuleId: String? = nil, query: MerchQuery? = nil, ruleName: String? = nil, status: String? = nil, zoneId: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    query = try container.decode(MerchQuery.self, forKey: .query)
