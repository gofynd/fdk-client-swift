...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class CreateAppPriceFactoryResponseSchema: Codable {
        ...
        public init(applicationId: String? = nil, code: String? = nil, createdBy: UserInfo? = nil, createdOn: String? = nil, currency: String? = nil, departmentIds: [Int]? = nil, factoryType: String? = nil, factoryTypeIds: [String]? = nil, isActive: Bool? = nil, modifiedBy: UserInfo? = nil, modifiedOn: String? = nil, name: String? = nil, id: String? = nil) {
