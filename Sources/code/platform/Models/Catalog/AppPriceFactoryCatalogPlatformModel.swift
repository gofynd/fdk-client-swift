...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class AppPriceFactory: Codable {
        ...
        public init(applicationId: String, code: String, createdBy: [String: Any]? = nil, createdOn: String? = nil, currency: String, departmentIds: [Int], factoryType: String, factoryTypeIds: [String], isActive: Bool, modifiedBy: [String: Any]? = nil, modifiedOn: String? = nil, name: String, uid: Int, id: String? = nil) {
