...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class CreateAppPriceFactoryProductResponse: Codable {
        ...
        public init(brand: String? = nil, category: String? = nil, companySizes: [CompanySizes]? = nil, factoryTypeId: [String]? = nil, itemCode: String? = nil, itemId: Int? = nil, itemName: String? = nil, media: [Media]? = nil, sizes: [PriceFactorySizes]? = nil) {
