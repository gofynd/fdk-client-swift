...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class UpdatePriceFactoryConfigSchema: Codable {
        ...
        public init(currencies: [String]? = nil, name: String? = nil, priceStrategy: [PriceStrategySchema]? = nil, priceZoneId: String? = nil) {
