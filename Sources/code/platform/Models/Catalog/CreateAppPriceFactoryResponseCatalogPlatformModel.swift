...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class CreateAppPriceFactoryResponse: Codable {
        ...
        public init(applicationId: String? = nil, code: String? = nil, createdBy: CreatedBy? = nil, createdOn: String? = nil, currency: String? = nil, departmentIds: [Int]? = nil, factoryType: String? = nil, factoryTypeIds: [String]? = nil, isActive: Bool? = nil, modifiedBy: CreatedBy? = nil, modifiedOn: String? = nil, name: String? = nil, uid: Int? = nil, id: String? = nil) {
