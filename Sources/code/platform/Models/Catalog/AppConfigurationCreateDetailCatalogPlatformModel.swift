...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class AppConfigurationCreateDetail: Codable {
        ...
        public init(appId: String? = nil, attributes: [AttributeDetailsGroup]? = nil, isActive: Bool, isDefault: Bool, logo: String? = nil, name: String? = nil, priority: Int, slug: String, templateSlugs: [String]? = nil) {
