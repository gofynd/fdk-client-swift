...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class TaxVersion: Codable {
        ...
        public init(applicableDate: String? = nil, companyId: Int? = nil, components: [TaxComponentRes]? = nil, createdOn: String? = nil, modifiedOn: String? = nil, ruleId: String? = nil, status: TaxStatusEnum? = nil, id: String? = nil) {
