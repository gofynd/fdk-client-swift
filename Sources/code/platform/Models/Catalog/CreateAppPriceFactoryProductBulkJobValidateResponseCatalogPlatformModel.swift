...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class CreateAppPriceFactoryProductBulkJobValidateResponse: Codable {
        ...
        public init(createdBy: CreatedBy? = nil, createdOn: String? = nil, filePath: String? = nil, fileType: String? = nil, jobId: String? = nil, jobType: String? = nil, modifiedBy: CreatedBy? = nil, modifiedOn: String? = nil, status: String? = nil) {
