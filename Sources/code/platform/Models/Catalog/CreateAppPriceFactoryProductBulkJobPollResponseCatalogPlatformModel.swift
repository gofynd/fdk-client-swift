...
public extension PlatformClient.Catalog {
    ...
    */
    ...
    class CreateAppPriceFactoryProductBulkJobPollResponse: Codable {
        ...
        public init(createdBy: CreatedBy? = nil, createdOn: String? = nil, errorFile: String? = nil, errorFileUrl: String? = nil, failedRecords: Int? = nil, isActive: Bool? = nil, modifiedBy: CreatedBy? = nil, modifiedOn: String? = nil, stage: String? = nil, status: String? = nil, successRecords: Int? = nil, totalRecords: Int? = nil, id: String? = nil) {
