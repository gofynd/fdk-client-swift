...
public extension PlatformClient.Lead {
    ...
    */
    ...
    class AddTicketPayload: Codable {
        ...
        public init(additionalInfo: [AdditionalInfo]? = nil, category: String, content: TicketContent, createdBy: [String: Any]? = nil, priority: PriorityEnum? = nil, status: String? = nil, customJson: [String: Any]? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    additionalInfo = try container.decode([AdditionalInfo].self, forKey: .additionalInfo)
