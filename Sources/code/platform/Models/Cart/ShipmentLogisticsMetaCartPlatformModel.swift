...
public extension PlatformClient.ApplicationClient.Cart {
    ...
    */
    ...
    class ShipmentLogisticsMeta: Codable {
        ...
        public var accountOptions: [String]?
        ...
        public init(accountInfo: [String: Any]? = nil, accountOptions: [String]? = nil, assignDpFromSb: String? = nil, dpSortKey: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    accountOptions = try container.decode([String].self, forKey: .accountOptions)
