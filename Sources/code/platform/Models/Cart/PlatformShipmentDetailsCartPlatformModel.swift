...
public extension PlatformClient.ApplicationClient.Cart {
    ...
    */
    ...
    class PlatformShipmentDetails: Codable {
        ...
        public init(articles: [ShipmentArticle]? = nil, boxType: String? = nil, dpId: String? = nil, dpOptions: [String: Any]? = nil, fulfillmentId: Int? = nil, fulfillmentOption: FulfillmentOptionSchema? = nil, fulfillmentType: String? = nil, items: [CartProductInfo]? = nil, orderType: String? = nil, promise: ShipmentPromise? = nil, shipments: Int? = nil, shipmentType: String? = nil) {
