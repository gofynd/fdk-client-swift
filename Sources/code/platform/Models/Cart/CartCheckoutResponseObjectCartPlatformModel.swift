...
public extension PlatformClient.ApplicationClient.Cart {
    ...
    */
    ...
    class CartCheckoutResponseObject: Codable {
        ...
        public init(appInterceptUrl: String? = nil, callbackUrl: String? = nil, cart: CheckCart? = nil, data: [String: Any]? = nil, errorMessage: String? = nil, message: String? = nil, orderId: String? = nil, paymentConfirmUrl: String? = nil, success: Bool? = nil) {
