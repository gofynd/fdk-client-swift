...
public extension PlatformClient.ApplicationClient.Cart {
    /*
        Model: PlatformCartShipmentsResponseObject
        Used By: Cart
    */

    class PlatformCartShipmentsResponseObject: Codable {
        ...
        public var shipments: [PlatformShipmentResponseObject]?
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    shipments = try container.decode([PlatformShipmentResponseObject].self, forKey: .shipments)
