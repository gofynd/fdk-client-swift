...
public extension PlatformClient.ApplicationClient.Cart {
    ...
    */
    ...
    class CouponDetailObj: Codable {
        ...
        public init(action: CouponAction? = nil, author: CouponAuthor? = nil, code: String? = nil, couponCounts: Double? = nil, couponPrefix: String? = nil, couponType: String? = nil, dateMeta: CouponDateMeta? = nil, displayMeta: DisplayMeta? = nil, identifiers: Identifier? = nil, isArchived: Bool? = nil, medias: [CartCouponMedias]? = nil, ownership: Ownership? = nil, restrictions: Restrictions? = nil, rule: [Rule]? = nil, ruleDefinition: RuleDefinition? = nil, state: State? = nil, tags: [String]? = nil, typeSlug: String? = nil, validation: Validation? = nil, validity: Validity? = nil, id: String? = nil, schedule: CouponSchedule? = nil) {
