...
public extension PlatformClient.ApplicationClient.Cart {
    ...
    */
    ...
    class CartMetaConfigUpdate: Codable {
        ...
        public init(allowCouponWithRewards: Bool? = nil, appId: String? = nil, articleTags: [String]? = nil, bulkCoupons: Bool? = nil, companyId: Double? = nil, deliveryCharges: DeliveryCharges? = nil, emptyCart: Bool? = nil, enabled: Bool? = nil, giftDisplayText: String? = nil, giftPricing: Double? = nil, gstInput: Bool? = nil, id: String? = nil, internationalDeliveryCharges: DeliveryCharges? = nil, isActive: Bool? = nil, isUniversal: Bool? = nil, lastModifiedBy: String? = nil, maxCartItems: Int? = nil, maxCartValue: Int? = nil, minCartValue: Int? = nil, name: String? = nil, orderPlacing: OrderPlacing? = nil, panCard: PanCard? = nil, placingForCustomer: Bool? = nil, revenueEngineCoupon: Bool? = nil, slug: String? = nil, staffSelection: Bool? = nil, updatedOn: String? = nil) {
