...
public extension PlatformClient.ApplicationClient.Cart {
    ...
    */
    ...
    class CartItemCustomOrder: Codable {
        
        
        public var isCustomOrder: Bool?
        
        public var manufacturingTime: Double?
        ...
        public init(isCustomOrder: Bool? = nil, manufacturingTime: Double? = nil, manufacturingTimeUnit: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    manufacturingTime = try container.decode(Double.self, forKey: .manufacturingTime)
