...
public extension PlatformClient.Content {
    ...
    */
    ...
    class NavigationRequestSchema: Codable {
        ...
        public init(assignments: [NavigationAssignment]? = nil, domain: String? = nil, name: String? = nil, navigation: [NavigationReference]? = nil, orientation: Orientation? = nil, platform: [String]? = nil, slug: String? = nil, tags: [String]? = nil) {
