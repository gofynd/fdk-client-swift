...
public extension PlatformClient.Webhook {
    ...
    */
    ...
    class SubscriberConfigResponse: Codable {
        ...
        public init(association: Association? = nil, authMeta: AuthMeta? = nil, createdOn: String? = nil, customHeaders: [String: Any]? = nil, emailId: String? = nil, eventId: [Int]? = nil, id: Int? = nil, modifiedBy: String? = nil, name: String? = nil, status: String? = nil, type: String? = nil, updatedOn: String? = nil, webhookUrl: String? = nil) {
