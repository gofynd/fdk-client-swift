...
public extension PlatformClient.Webhook {
    ...
    class SubscriberConfig: Codable {
        ...
        public init(association: Association? = nil, authMeta: AuthMeta? = nil, customHeaders: [String: Any]? = nil, emailId: String? = nil, eventId: [Int]? = nil, id: Int? = nil, name: String? = nil, status: String? = nil, webhookUrl: String? = nil) {
            self.id = id
