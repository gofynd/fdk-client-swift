...
public extension PlatformClient.Webhook {
    ...
    */
    ...
    class SubscriberConfigRequestV2: Codable {
        ...
        public init(association: Association? = nil, authMeta: AuthMeta? = nil, customHeaders: [String: Any]? = nil, emailId: String? = nil, events: [Events]? = nil, id: Int? = nil, name: String? = nil, provider: String? = nil, status: String? = nil, webhookUrl: String? = nil) {
