...
public extension PlatformClient.Configuration {
    ...
    */
    ...
    class ApplicationById: Codable {
        ...
        public var tokens: [TokenSchemaID]?
        ...
        public init(appType: String? = nil, auth: ApplicationAuth? = nil, banner: SecureUrl? = nil, cacheTtl: Int? = nil, channelType: String? = nil, companyId: Int? = nil, cors: ApplicationCors? = nil, createdAt: String? = nil, description: String? = nil, domain: Domain? = nil, domains: [Domain]? = nil, favicon: SecureUrl? = nil, isActive: Bool? = nil, isInternal: Bool? = nil, logo: SecureUrl? = nil, meta: [ApplicationMeta]? = nil, mobileLogo: SecureUrl? = nil, mode: String? = nil, modifiedAt: String? = nil, name: String? = nil, owner: String? = nil, redirections: [ApplicationRedirections]? = nil, secret: String? = nil, slug: String? = nil, status: String? = nil, token: String? = nil, tokens: [TokenSchemaID]? = nil, website: ApplicationWebsite? = nil, id: String? = nil, v: Int? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    tokens = try container.decode([TokenSchemaID].self, forKey: .tokens)
