...
public extension PlatformClient {
    class Catalog {
        ...
        public func getSellerInsights(
            ...
            onResponse: @escaping (_ response: CrossSellingDataResponse?, _ error: FDKError?) -> Void
        ) {
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                ...
                onResponse: { responseData, error, responseCode in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(CrossSellingDataResponse.self, from: data)
        ...
        public func listDepartments(
            ...
            onResponse: @escaping (_ response: DepartmentListResponse?, _ error: FDKError?) -> Void
        ) {
            var xQuery: [String: Any] = [:]
            ...
            PlatformAPIClient.execute(
                ...
                onResponse: { responseData, error, responseCode in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(DepartmentListResponse.self, from: data)
         ...
         **/
        public func getDepartment(
            uid: Int,

            onResponse: @escaping (_ response: DepartmentUpdate?, _ error: FDKError?) -> Void
        ) {
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                ...
                onResponse: { responseData, error, responseCode in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(DepartmentUpdate.self, from: data)
