        ...
        **/
        public func uploadBulkProducts(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "POST",
                url: "/service/platform/catalog/v3.0/company/\(companyId)/products/bulk",
                query: xQuery,
                body: body.dictionary,
                headers: xHeaders,
                responseType: "application/json",
...
Supports optional filtering and pagination.
        ...
        * Description: Create component names for a product.
        **/
        public func createTaxComponentName(
            body: CreateTaxComponentName,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: TaxComponentRes?, _ error: FDKError?) -> Void
        ) {
            ...
            PlatformAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(TaxComponentRes.self, from: data)
