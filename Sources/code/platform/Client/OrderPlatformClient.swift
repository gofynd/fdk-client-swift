    ...
    class Order {
        ...
        public func getBulkInvoice(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/order/v1.0/company/\(companyId)/bulk-action/invoice",
                query: xQuery,
                body: nil,
                headers: [],
                responseType: "application/json",
        ...
        public func getBulkInvoiceLabel(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/order/v1.0/company/\(companyId)/invoice-label-external",
                query: xQuery,
                body: nil,
                headers: [],
                responseType: "application/json",
        ...
        public func getBulkList(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/order/v1.0/company/\(companyId)/bulk-action/listing",
                query: xQuery,
                body: nil,
                headers: [],
                responseType: "application/json",
        ...
        public func getBulkActionFailedReport(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/order/v1.0/company/\(companyId)/bulk-action-failed-report/",
                query: xQuery,
                body: nil,
                headers: [],
                responseType: "application/json",
        ...
        public func bulkActionProcessXlsxFile(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "post",
                url: "/service/platform/order/v2.0/company/\(companyId)/bulk-action/",
                query: nil,
                body: body.dictionary,
                headers: [],
                responseType: "application/json",
        ...
        public func bulkActionDetails(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/order/v2.0/company/\(companyId)/bulkAction/\(batchId)",
                query: nil,
                body: nil,
                headers: [],
                responseType: "application/json",
        ...
        public func verifyMobileOTP(
            ...
            onResponse: @escaping (_ response: PointBlankOtpData?, _ error: FDKError?) -> Void
        ) {
            PlatformAPIClient.execute(
                config: config,
                method: "post",
                ...
                onResponse: { responseData, error, responseCode in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(PointBlankOtpData.self, from: data)
