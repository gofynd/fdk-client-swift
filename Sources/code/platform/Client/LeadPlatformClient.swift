...
extension PlatformClient {
    ...
    public class Lead {        
        ...
        * Description: Create a new ticket at platform level
        **/
        ...
        **/
        public func getGeneralConfig(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: GeneralConfigResponseSchema?, _ error: FDKError?) -> Void
        ) {
            ...
            PlatformAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(GeneralConfigResponseSchema.self, from: data)
