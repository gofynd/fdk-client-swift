...
if let value = sort {
    ...
    xQuery["sort"] = value
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/webhook/v1.0/company/\(companyId)/audit-trail/logs",
                query: xQuery,
                body: nil,
                headers: [],
        ...
        **/
        public func getAuditLog(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/webhook/v1.0/company/\(companyId)/auditTrail/logs/\(id)",
                query: nil,
                body: nil,
                headers: [],
                responseType: "application/json",
        ...
        **/
        public func getEntityTypes(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/webhook/v1.0/company/\(companyId)/audit-trail/entity-types",
                query: nil,
                body: nil,
                headers: [],
                responseType: "application/json",
