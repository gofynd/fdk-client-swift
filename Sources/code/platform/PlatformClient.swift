...
public class PlatformClient {
    ...
    public class ApplicationClient {
        ...
        public class Configuration {
            ...
            /**
                         *
                         * Summary: Get domains list attached with the current application.
                         * Description: Gives the domains list attached with the current application.
