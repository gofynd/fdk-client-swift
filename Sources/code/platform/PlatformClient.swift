...
public class PlatformClient {
    ...
    public class ApplicationClient {
        ...
        public class Serviceability {
             ...
             **/
            public func upsertDpApplicationRulesView(
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "put",
                    url: "/service/platform/logistics/v1.0/company/\(companyId)/application/\(applicationId)/logistics",
                    query: nil,
                    body: body.dictionary,
                    headers: [],
                    responseType: "application/json",
             ...
             **/
            public func getDpApplicationRulesView(
                onResponse: @escaping (_ response: DPApplicationRuleResponse?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
