...
public class PlatformClient {
    ...
    public class ApplicationClient {
        ...
        public class Theme {
             ...
             **/
            public func getDefaultPageDetails(
                pageValue: String,
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    url: "/service/platform/theme/v1.0/company/\(companyId)/application/\(applicationId)/page/\(pageValue)/default",
                    query: nil,
                    body: nil,
                    headers: [],
                    responseType: "application/json",
             ...
             * Description:
             **/
            public func getApplicationThemesV2(
                onResponse: @escaping (_ response: [AllThemesApplicationResponseV2]?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    ...
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode([AllThemesApplicationResponseV2].self, from: data)
             ...
             * Description:
             **/
            public func getApplicationThemesCountV2(
                onResponse: @escaping (_ response: [String: Any]?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
             ...
             * Description:
             **/
            public func getApplicationThemeByIdV2(
                themeId: String,
             ...
             **/
            public func addThemeToApplicationV2(
                body: ApplyThemeRequestV2,
                onResponse: @escaping (_ response: ApplyThemeResponseV2?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "post",
                    ...
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(ApplyThemeResponseV2.self, from: data)
             ...
             * Description:
             **/
            public func getThemePreviewByIdV2(
                themeId: String,
             ...
             * Description: Use this API to fetch Last-Modified timestamp in header metadata.
             **/
            public func getThemeLastModifiedV2(
                themeId: String,
             ...
             **/
            public func checkThemeUpgradableV2(
                themeId: String,

                onResponse: @escaping (_ response: ThemeUpgradableResponseV2?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    ...
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(ThemeUpgradableResponseV2.self, from: data)
             ...
             **/
            public func upgradeApplicationV2(
                themeId: String,
        ...
        public class Communication {
            ...
            public func deleteEmailProviderById(
                ...
                onResponse: @escaping (_ response: GenericSuccess?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "delete",
                    ...
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(GenericSuccess.self, from: data)
             ...
             **/
            public func getVoiceProviders(
                pageNo: Int?,
                pageSize: Int?,
                sort: [String: Any]?,

                onResponse: @escaping (_ response: VoiceProviders?, _ error: FDKError?) -> Void
            ) {
                var xQuery: [String: Any] = [:]
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    url: "/service/platform/communication/v1.0/company/\(companyId)/application/\(applicationId)/voice/providers",
                    query: xQuery,
                    body: nil,
                    headers: [],
                    responseType: "application/json",
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(VoiceProviders.self, from: data)
             ...
             **/
            public func createVoiceProvider(
                body: VoiceProviderReq,
                onResponse: @escaping (_ response: VoiceProvider?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "post",
                    ...
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(VoiceProvider.self, from: data)
             ...
             **/
            public func getVoiceProviderById(
                id: String,
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    url: "/service/platform/communication/v1.0/company/\(companyId)/application/\(applicationId)/voice/providers/\(id)",
                    query: nil,
                    body: nil,
                    headers: [],
                    responseType: "application/json",
             ...
             **/
            public func getVoiceTemplates(
                pageNo: Int?,
                pageSize: Int?,
                sort: [String: Any]?,

                onResponse: @escaping (_ response: VoiceTemplates?, _ error: FDKError?) -> Void
            ) {
                var xQuery: [String: Any] = [:]
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    url: "/service/platform/communication/v1.0/company/\(companyId)/application/\(applicationId)/voice/templates",
                    query: xQuery,
                    body: nil,
                    headers: [],
                    responseType: "application/json",
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(VoiceTemplates.self, from: data)
            ...
            public func createVoiceTemplate(
                ...
                onResponse: @escaping (_ response: VoiceTemplateRes?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "post",
                    ...
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(VoiceTemplateRes.self, from: data)
             ...
             **/
            public func getVoiceTemplateById(
                id: String,

                onResponse: @escaping (_ response: VoiceTemplate?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    url: "/service/platform/communication/v1.0/company/\(companyId)/application/\(applicationId)/voice/templates/\(id)",
                    query: nil,
                    body: nil,
                    headers: [],
                    responseType: "application/json",
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(VoiceTemplate.self, from: data)
             ...
             **/
            public func updateVoiceTemplateById(
                id: String,
                body: VoiceTemplateReq,
                onResponse: @escaping (_ response: VoiceTemplateRes?, _ error: FDKError?) -> Void
            ) {
             ...
             **/
            public func deleteVoiceTemplateById(
                id: String,

                onResponse: @escaping (_ response: VoiceTemplateDeleteSuccessRes?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "delete",
                    ...
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(VoiceTemplateDeleteSuccessRes.self, from: data)
             ...
             **/
            public func getSystemVoiceTemplates(
                pageNo: Int?,
                pageSize: Int?,
                sort: [String: Any]?,

                onResponse: @escaping (_ response: SystemVoiceTemplates?, _ error: FDKError?) -> Void
            ) {
                var xQuery: [String: Any] = [:]
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    url: "/service/platform/communication/v1.0/company/\(companyId)/application/\(applicationId)/voice/system-templates",
                    query: xQuery,
                    body: nil,
                    headers: [],
                    responseType: "application/json",
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(SystemVoiceTemplates.self, from: data)
        ...
        public class Payment {
             ...
             **/
            public func extensionPaymentUpdate(
                body: ExtensionPaymentUpdateRequestSerializer,
                onResponse: @escaping (_ response: ExtensionPaymentUpdateResponseSerializer?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "post",
                    url: "/service/platform/payment/v1.0/company/\(companyId)/application/\(applicationId)/payment/update/",
                    query: nil,
                    body: body.dictionary,
                    headers: [],
                    responseType: "application/json",
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(ExtensionPaymentUpdateResponseSerializer.self, from: data)
        ...
        public class Order {
            ...
            public func getAppOrderShipmentDetails(
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    url: "/service/platform/order/v1.0/company/\(companyId)/application/\(applicationId)/order-details",
                    query: xQuery,
                    body: nil,
                    headers: [],
                    responseType: "application/json",
        ...
        public class Catalog {
             ...
             **/
            public func getProductSizeSellers(
                itemId: String,
                size: String,
                pincode: String?,
                strategy: String?,
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    url: "/service/platform/catalog/v1.0/company/\(companyId)/application/\(applicationId)/products/\(itemId)/sizes/\(size)/sellers/",
                    query: xQuery,
                    body: nil,
                    headers: [],
                    responseType: "application/json",
            ...
            /**
             *
             * Summary: get paginator for getProductSizeSellers
             * Description: fetch the next page by calling .next(...) function
             **/
            public func getProductSizeSellersPaginator(
                itemId: String,
                size: String,
                pincode: String?,
                strategy: String?,
        ...
        public class Cart {
             ...
             **/
            public func updateCartDynamicInjection(
                id: String,
                body: CartDynamicInjectionUpdate,
                onResponse: @escaping (_ response: CartDynamicInjectionResponse?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "put",
                    url: "/service/platform/cart/v1.0/company/\(companyId)/application/\(applicationId)/additionalChargeDiscount/\(id)",
                    query: nil,
                    body: body.dictionary,
                    headers: [],
                    responseType: "application/json",
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(CartDynamicInjectionResponse.self, from: data)
             ...
             **/
            public func removeCartDynamicInjection(
                id: String,
             ...
             **/
            public func createCartDynamicInjection(
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "post",
                    url: "/service/platform/cart/v1.0/company/\(companyId)/application/\(applicationId)/additional-charge-discount",
                    query: nil,
                    body: body.dictionary,
                    headers: [],
                    responseType: "application/json",
