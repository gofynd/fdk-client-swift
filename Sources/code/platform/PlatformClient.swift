...
public class PlatformClient {
    ...
    public let orderInvoiceEngine: OrderInvoiceEngine
    ...
    public init(config: PlatformConfig) {
        ...
        orderInvoiceEngine = OrderInvoiceEngine(config: config)
    ...
    public class ApplicationClient {
        ...
        public init(applicationId: String, config: PlatformConfig) {
            ...
            orders = Orders(config: config, applicationId: applicationId)
        ...
        public class User {
            ...
            /**
             *
             * Summary: unarchive user who archived from applcation
             * Description: unarchive user who archived from applcation
             **/
            public func unArchiveUser(
                body: UnArchiveUserRequestSchema,
                onResponse: @escaping (_ response: UnArchiveUserSuccess?, _ error: FDKError?) -> Void
            ) {
                PlatformAPIClient.execute(
                    config: config,
                    method: "put",
                    url: "/service/platform/user/v1.0/company/\(companyId)/application/\(applicationId)/customers/unarchive",
                    query: nil,
                    body: body.dictionary,
                    headers: [],
                    responseType: "application/json",
                    onResponse: { responseData, error, responseCode in
                        if let _ = error, let data = responseData {
                            ...
                            let response = Utility.decode(UnArchiveUserSuccess.self, from: data)
        ...
        public class Order {
             ...
             **/
            public func getApplicationOrderDetails(
                orderId: String?,
                next: String?,
                previous: String?,
        ...
        public class Serviceability {
            ...
            public func getApplicationServiceability(
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "get",
                    url: "/service/platform/logistics-internal/v1.0/company/\(companyId)/application/\(applicationId)/serviceability",
                    query: nil,
                    body: nil,
                    headers: [],
                    responseType: "application/json",
            ...
            public func upsertZoneControllerView(
                ...
                PlatformAPIClient.execute(
                    config: config,
                    method: "post",
                    url: "/service/platform/logistics-internal/v1.0/company/\(companyId)/application/\(applicationId)/zones",
                    query: nil,
                    body: body.dictionary,
                    headers: [],
                    responseType: "application/json",
