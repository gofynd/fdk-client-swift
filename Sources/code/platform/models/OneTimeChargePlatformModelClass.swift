...
public extension PlatformClient {
    ...
    class OneTimeCharge: Codable {
        ...
        public init(activatedOn: String? = nil, billingDate: String? = nil, cancelledOn: String? = nil, cappedAmount: Double? = nil, isTest: Bool? = nil, metadata: [String: Any]? = nil, name: String? = nil, price: EntityChargePrice? = nil, pricingType: String? = nil, status: String? = nil, term: String? = nil, id: String? = nil) {
            self.id = id
