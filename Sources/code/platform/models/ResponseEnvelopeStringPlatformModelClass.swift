...
public extension PlatformClient {
    ...
    class ResponseEnvelopeString: Codable {
        ...
        public init(error: String? = nil, exception: String? = nil, httpStatus: String? = nil, items: String? = nil, message: String? = nil, page: Page? = nil, payload: String? = nil, status: Int? = nil, timestamp: String? = nil, totalTimeTakenInMillis: Int? = nil, traceId: String? = nil) {
