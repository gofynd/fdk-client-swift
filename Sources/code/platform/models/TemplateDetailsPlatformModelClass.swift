...
public extension PlatformClient {
    ...
    class TemplateDetails: Codable {
        ...
        public init(attributes: [String]? = nil, attributeSchemaOverride: [AttributeSchemaOverride]? = nil, categories: [String]? = nil, departments: [String]? = nil, description: String? = nil, id: String? = nil, isActive: Bool? = nil, isArchived: Bool? = nil, isExpirable: Bool, isPhysical: Bool, logo: String? = nil, name: String? = nil, sizes: [String]? = nil, slug: String, tag: String? = nil) {
            self.tag = tag
