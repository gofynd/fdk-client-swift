...
public extension PlatformClient {
    ...
    class PlatformOrderItems: Codable {
        ...
        public var breakupValues: [PlatformBreakupValues1]?
        ...
        public init(breakupValues: [PlatformBreakupValues1]? = nil, channel: PlatformChannel? = nil, meta: [String: Any]? = nil, orderCreatedTime: String? = nil, orderId: String? = nil, orderValue: Double? = nil, paymentMode: String? = nil, shipments: [PlatformShipment1]? = nil, totalOrderValue: Double? = nil, userInfo: UserDataInfo? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                breakupValues = try container.decode([PlatformBreakupValues1].self, forKey: .breakupValues)
