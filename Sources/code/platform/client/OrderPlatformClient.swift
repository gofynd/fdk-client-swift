    ...
    class Order {
        ...
        public func getReasonCodes(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/order-manage/v1.0/company/\(companyId)/get-reason-codes",
                query: xQuery,
                body: nil,
                headers: [],
                responseType: "application/json",
                onResponse: { responseData, error, responseCode in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(ReasonCodesResponse.self, from: data)
        ...
        public func getOrderById(
            ...
            if let value = fyndOrderId {
                xQuery["fynd_order_id"] = value
            }
        ...
        public func getOrders(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/orders/v1.0/company/\(companyId)/orders",
                query: xQuery,
                body: nil,
                headers: [],
                responseType: "application/json",
