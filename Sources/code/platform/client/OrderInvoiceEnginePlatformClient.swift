    ...
    class OrderInvoiceEngine {
        ...
        public func generateNoc(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "post",
                url: "/service/platform/invoice/v1.0/company/\(companyId)/generate-noc",
                query: nil,
                body: body.dictionary,
                headers: [],
                responseType: "application/json",
        ...
        public func getNocStatus(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/invoice/v1.0/company/\(companyId)/get-noc-status",
                query: xQuery,
                body: nil,
                headers: [],
                responseType: "application/json",
        ...
        public func getNocPresignedURL(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/invoice/v1.0/company/\(companyId)/get-noc-presigned-url",
                query: xQuery,
                body: nil,
                headers: [],
                responseType: "application/json",
