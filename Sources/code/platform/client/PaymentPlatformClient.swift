...
public extension PlatformClient {
    class Payment {
         ...
         **/
        public func getPayoutPennyDropAndChequeConfig(
            onResponse: @escaping (_ response: PayoutPennyDropAndChequePayload?, _ error: FDKError?) -> Void
        ) {
            PlatformAPIClient.execute(
                config: config,
                method: "get",
                url: "/service/platform/payment/v1.0/company/\(companyId)/payout/bank/config",
                query: nil,
                body: nil,
                headers: [],
                responseType: "application/json",
                onResponse: { responseData, error, responseCode in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(PayoutPennyDropAndChequePayload.self, from: data)
        ...
        public func paymentStatusBulk(
            ...
            PlatformAPIClient.execute(
                config: config,
                method: "post",
                url: "/service/platform/payment/v1.0/company/\(companyId)/payment-status-bulk/",
                query: nil,
                body: body.dictionary,
                headers: [],
                responseType: "application/json",
