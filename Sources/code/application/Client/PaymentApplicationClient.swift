...
extension ApplicationClient {
    ...
    public class Payment {
        ...
        init(config: ApplicationConfig) {
            ...
            ulrs["getRefundBeneficiaries"] = config.domain.appendAsPath("/service/application/payment/v2.0/refund/user/beneficiary") 
            
            ulrs["addBeneficiary"] = config.domain.appendAsPath("/service/application/payment/v2.0/refund/user/beneficiary") 
            
            ulrs["deleteBeneficiary"] = config.domain.appendAsPath("/service/application/payment/v1.0/refund/account/{id}") 
            
            ulrs["getRefundBeneficiariesUsingOTPSession"] = config.domain.appendAsPath("/service/application/payment/v2.0/refund/user/beneficiary-otp") 
        ...
        **/
        public func getRefundBeneficiaries(
            ...
            let fullUrl = relativeUrls["getRefundBeneficiaries"] ?? ""
        ...
        * Description: Adds a bank or UPI beneficiary to the user account for processing refunds.
        **/
        public func addBeneficiary(
            body: AddBeneficiaryRequestDetails,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: AddBeneficiaryResponseDetails?, _ error: FDKError?) -> Void
        ) {
            ...
            let fullUrl = relativeUrls["addBeneficiary"] ?? ""
        ...
        * Description: This API endpoint is used to delete a refund beneficiary using their beneficiary ID.
        **/
        public func deleteBeneficiary(
            id: String,
            
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: DeleteBeneficiaryDetails?, _ error: FDKError?) -> Void
        ) {
            ...
            var fullUrl = relativeUrls["deleteBeneficiary"] ?? ""
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(DeleteBeneficiaryDetails.self, from: data)
        ...
        **/
        public func getRefundBeneficiariesUsingOTPSession(
            orderId: String?,
            shipmentId: String?,
            filterBy: String?,
            ...
            let fullUrl = relativeUrls["getRefundBeneficiariesUsingOTPSession"] ?? ""
        ...
        * Description: Adds a bank or UPI beneficiary to the user account after completing an OTP verification session. The beneficiary details are securely linked with the user's refund preferences and will be used for processing refunds against specific orders and shipments.
        **/
        public func addRefundBeneficiaryUsingOTPSession(
            body: AddBeneficiaryRequestDetails,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: AddBeneficiaryResponseDetails?, _ error: FDKError?) -> Void
        ) {
            ...
            let fullUrl = relativeUrls["addRefundBeneficiaryUsingOTPSession"] ?? ""
