...
public extension ApplicationClient {
    class Logistic {
        ...
        init(config: ApplicationConfig) {
            ...
            ulrs["getCountries"] = config.domain.appendAsPath("/service/application/logistics/v1.0/country")

            ulrs["getCountry"] = config.domain.appendAsPath("/service/application/logistics/v1.0/country/{uid}")

            ulrs["getLocalities"] = config.domain.appendAsPath("/service/application/logistics/v1.0/locality/{region}")

            ulrs["getLocality"] = config.domain.appendAsPath("/service/application/logistics/v1.0/locality/{region}/{value}")
        ...
        public func getCountry(
            ...
            fullUrl = fullUrl.replacingOccurrences(of: "{" + "uid" + "}", with: "\(uid)")
        ...
        public func getLocalities(
            ...
            fullUrl = fullUrl.replacingOccurrences(of: "{" + "region" + "}", with: "\(region)")
        ...
        public func getLocality(
            ...
            fullUrl = fullUrl.replacingOccurrences(of: "{" + "value" + "}", with: "\(value)")
