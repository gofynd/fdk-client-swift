    ...
    public class Cart {
        ...
        **/
        public func getCart(
            ...
            onResponse: @escaping (_ response: CartDetailResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(CartDetailResponseObject.self, from: data)
        ...
        **/
        public func addItems(
            ...
            cartType: String?,
            orderType: String?,
            body: AddCartRequestObject,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: AddCartDetailResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(AddCartDetailResponseObject.self, from: data)
        ...
        **/
        public func updateCart(
            ...
            cartType: String?,
            orderType: String?,
            body: UpdateCartRequestObject,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: UpdateCartDetailResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(UpdateCartDetailResponseObject.self, from: data)
        ...
        **/
        public func deleteCart(
            id: String?,
            cartType: String?,
            body: DeleteCartRequestObject,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: DeleteCartDetail?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(DeleteCartDetail.self, from: data)
        ...
        **/
        public func getItemCount(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: CartItemCount?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(CartItemCount.self, from: data)
        ...
        **/
        public func getCoupons(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: GetCouponResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(GetCouponResponseObject.self, from: data)
        ...
        **/
        public func getBulkDiscountOffers(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: BulkPriceResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(BulkPriceResponseObject.self, from: data)
        ...
        **/
        public func getAddresses(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: GetAddressesResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(GetAddressesResponseObject.self, from: data)
        ...
        **/
        public func addAddress(
            body: Address,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: SaveAddressResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(SaveAddressResponseObject.self, from: data)
        ...
        **/
        public func updateAddress(
            ...
            body: Address,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: UpdateAddress?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(UpdateAddress.self, from: data)
        ...
        **/
        public func removeAddress(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: DeleteAddressResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(DeleteAddressResponseObject.self, from: data)
        ...
        **/
        public func selectAddress(
            ...
            i: Bool?,
            b: Bool?,
            body: SelectCartAddressRequestObject,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: CartDetailResponseObject?, _ error: FDKError?) -> Void
        ) {
        ...
        **/
        public func selectPaymentMode(
            ...
            buyNow: Bool?,
            orderType: String?,
            body: UpdateCartPaymentRequestObject,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: CartDetailResponseObject?, _ error: FDKError?) -> Void
        ) {
        ...
        **/
        public func updateCartMeta(
            id: String?,
            buyNow: Bool?,
            body: CartMetaRequestObject,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: CartMetaResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(CartMetaResponseObject.self, from: data)
        ...
        **/
        public func getCartShareLink(
            body: GetShareCartLinkRequestObject,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: GetShareCartLinkResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(GetShareCartLinkResponseObject.self, from: data)
        ...
        **/
        public func getCartSharedItems(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: SharedCartResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(SharedCartResponseObject.self, from: data)
        ...
        **/
        public func getPromotionOffers(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: PromotionOffersResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(PromotionOffersResponseObject.self, from: data)
        ...
        **/
        public func getShipments(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: CartShipments?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(CartShipments.self, from: data)
        ...
        **/
        public func checkoutCart(
            buyNow: Bool?,
            cartType: String?,
            body: CartCheckoutDetailRequestObject,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: CartCheckoutResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(CartCheckoutResponseObject.self, from: data)
        ...
        **/
        public func checkoutCartV2(
            buyNow: Bool?,
            cartType: String?,
            body: CartCheckoutDetailV2RequestObject,
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: CartCheckoutResponseObject?, _ error: FDKError?) -> Void
        ) {
        ...
        **/
        public func getPaymentPromotionOffers(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: PromotionPaymentOffersResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(PromotionPaymentOffersResponseObject.self, from: data)
        ...
        **/
        public func getCartMetaConfigs(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: CartMetaConfigListResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(CartMetaConfigListResponseObject.self, from: data)
        ...
        **/
        public func getCartMetaConfig(
            ...
            headers: [(key: String, value: String)]? = nil,
            onResponse: @escaping (_ response: CartConfigDetailResponseObject?, _ error: FDKError?) -> Void
        ) {
            ...
            ApplicationAPIClient.execute(
                ...
                onResponse: { (responseData, error, responseCode) in
                    if let _ = error, let data = responseData {
                        ...
                        let response = Utility.decode(CartConfigDetailResponseObject.self, from: data)
