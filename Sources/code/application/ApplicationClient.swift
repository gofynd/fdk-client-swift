...
public class ApplicationClient {
    ...
    public class Catalog {
        ...
        init(config: ApplicationConfig) {
            ...
            ulrs["getCollections"] = config.domain.appendAsPath("/service/application/catalog/v2.0/collections/")

            ulrs["getCollectionItemsBySlug"] = config.domain.appendAsPath("/service/application/catalog/v2.0/collections/{slug}/items/")

            ulrs["getCollectionDetailBySlug"] = config.domain.appendAsPath("/service/application/catalog/v2.0/collections/{slug}/")
