...
public extension ApplicationClient.Cart {
    ...
    */
    class CartShipments: Codable {
        ...
        public var shipments: [ShipmentResponseObject]?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                shipments = try container.decode([ShipmentResponseObject].self, forKey: .shipments)
