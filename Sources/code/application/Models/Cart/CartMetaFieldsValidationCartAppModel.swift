...
public extension ApplicationClient.Cart {
    ...
    */
    class CartMetaFieldsValidation: Codable {
        ...
        public init(checkoutMode: [String]? = nil, comment: [String]? = nil, customCartMeta: [String: Any]? = nil, deliverySlots: [String]? = nil, giftDetails: [String]? = nil, gstin: [String]? = nil, panNo: [String]? = nil, pickUpCustomerDetails: [String]? = nil, staffUserId: [String]? = nil) {
