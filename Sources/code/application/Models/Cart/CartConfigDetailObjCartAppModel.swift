...
public extension ApplicationClient.Cart {
    ...
    */
    class CartConfigDetailObj: Codable {
        ...
        public init(allowCouponWithRewards: Bool? = nil, appId: String? = nil, articleTags: [String]? = nil, bulkCoupons: Bool? = nil, companyId: Int? = nil, createdOn: String? = nil, deliveryCharges: DeliveryChargesConfig? = nil, enabled: Bool? = nil, giftDisplayText: String? = nil, giftPricing: Double? = nil, gstInput: Bool? = nil, id: String? = nil, internationalDeliveryCharges: DeliveryChargesConfig? = nil, isActive: Bool? = nil, isUniversal: Bool? = nil, lastModifiedBy: String? = nil, maxCartItems: Int? = nil, maxCartValue: Int? = nil, minCartValue: Int? = nil, name: String? = nil, orderPlacing: OrderPlacing? = nil, panCard: PanCard? = nil, placingForCustomer: Bool? = nil, revenueEngineCoupon: Bool? = nil, slug: String? = nil, staffSelection: Bool? = nil, updatedOn: String? = nil) {
