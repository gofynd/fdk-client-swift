...
public extension ApplicationClient.Cart {
    ...
    */
    class DisplayBreakup: Codable {
        ...
        public init(attr: String? = nil, currencyCode: String? = nil, currencySymbol: String? = nil, display: String? = nil, key: String? = nil, message: [String]? = nil, meta: [String: Any]? = nil, original: Double? = nil, preset: Double? = nil, value: Double? = nil) {
