...
public extension ApplicationClient.Cart {
    ...
    */
    class ShipmentMeta: Codable {
        ...
        public init(assignDpFromSb: String? = nil, debug: [String: Any]? = nil, dimension: ShipmentMetaDimension? = nil, dpSortKey: String? = nil, packagingName: String? = nil, shipmentChargeableWeight: Double? = nil, shipmentVolumetricWeight: Double? = nil, shipmentWeight: Double? = nil, shippingZone: String? = nil) {
