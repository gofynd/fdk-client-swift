...
public extension ApplicationClient.Logistic {
    ...
    */
    class GeoAreaItemResponse: Codable {
        ...
        public init(applicationId: String, areas: [AreaExpandedV2]? = nil, companyId: Int, createdBy: String, createdOn: String, geoareaId: String, isActive: Bool, modifiedBy: String, modifiedOn: String, name: String, regionType: String, slug: String, type: String? = nil) {
