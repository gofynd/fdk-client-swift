...
public extension ApplicationClient.Logistic {
    ...
    */
    class CourierPartner: Codable {
        ...
        public init(areaCode: AreaCode? = nil, displayName: String? = nil, extensionId: String? = nil, forwardPickupCutoff: String? = nil, isOwnAccount: Bool? = nil, isQcEnabled: Bool? = nil, isSelfShip: Bool? = nil, ndrAttempts: Int? = nil, reversePickupCutoff: String? = nil, schemeId: String? = nil, tat: TAT? = nil) {
