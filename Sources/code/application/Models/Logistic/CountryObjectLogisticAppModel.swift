...
public extension ApplicationClient.Logistic {
    ...
    */
    class CountryObject: Codable {
        ...
        public init(currency: CurrencyObject? = nil, displayName: String? = nil, hierarchy: [CountryHierarchy]? = nil, id: String? = nil, iso2: String? = nil, iso3: String? = nil, latitude: String? = nil, longitude: String? = nil, name: String? = nil, phoneCode: String? = nil, timezones: [String]? = nil, type: String? = nil) {
