...
public extension ApplicationClient.Logistic {
    /*
        ...
        Used By: Logistic
    */
    class LocationDetailsArticle: Codable {
        ...
        public var groupInfoIds: [String]?
        ...
        public init(attributes: ArticleAttributes? = nil, brandId: Int, categoryId: Int, deliverySlots: ArticleDeliverySlots, departmentId: Int, dimension: ArticleDimension, groupId: String? = nil, groupInfo: [String: Any]? = nil, groupInfoIds: [String]? = nil, id: String, isGift: Bool, isSet: Bool, itemId: Int, manufacturingTime: Int? = nil, manufacturingTimeUnit: String? = nil, mtoQuantity: Int? = nil, price: Double, quantity: Int, returnReason: ArticleReturnReason? = nil, set: ArticleSet? = nil, setQuantity: Int? = nil, size: String, tags: [String], weight: ArticleWeight) {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                groupInfoIds = try container.decode([String].self, forKey: .groupInfoIds)
