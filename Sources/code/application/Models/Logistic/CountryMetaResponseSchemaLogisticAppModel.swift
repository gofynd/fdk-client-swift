...
public extension ApplicationClient.Logistic {
    /*
        ...
        Used By: Logistic
    */
    class CountryMetaResponseSchema: Codable {
        ...
        public var logistics: LogisticsResponseSchema?
        ...
        public init(currency: CurrencyObject? = nil, deliverables: [String]? = nil, hierarchy: [CountryHierarchy]? = nil, iso2: String? = nil, iso3: String? = nil, logistics: LogisticsResponseSchema? = nil, parentId: String? = nil, phoneCode: String? = nil, zone: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                logistics = try container.decode(LogisticsResponseSchema.self, forKey: .logistics)
