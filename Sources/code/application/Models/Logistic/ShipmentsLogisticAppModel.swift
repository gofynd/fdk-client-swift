...
public extension ApplicationClient.Logistic {
    ...
    */
    class Shipments: Codable {
        ...
        public init(articles: [ShipmentsArticles], count: Int, courierPartners: [ShipmentCourierPartners], deliverySlots: ArticleDeliverySlots? = nil, fromServiceability: [String: Any], fulfillmentId: Int, isAutoAssign: Bool, isGift: Bool, isLocked: Bool, isMto: Bool, packaging: Packaging, promise: PromiseObject? = nil, shipmentType: String, tags: [String]? = nil, volumetricWeight: Double, weight: Double) {
