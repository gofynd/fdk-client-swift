...
public extension ApplicationClient.Logistic {
    ...
    */
    class LocalitiesApp: Codable {
        ...
        public init(code: String? = nil, currency: [String: Any]? = nil, customMeta: [String: Any]? = nil, displayName: String? = nil, hierarchy: [String: Any]? = nil, id: String? = nil, iso2: String? = nil, iso3: String? = nil, latitude: String? = nil, latLong: PincodeLatLongData? = nil, localities: [LocalityParent]? = nil, longitude: String? = nil, meta: [String: Any]? = nil, name: String? = nil, parentIds: [String]? = nil, parentUid: String? = nil, phoneCode: String? = nil, type: String? = nil) {
