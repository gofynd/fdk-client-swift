...
public extension ApplicationClient.Logistic {
    /*
        ...
        Used By: Logistic
    */
    class TATViewResponseSchema: Codable {
        ...
        public var locationDetails: [TATLocationDetailsResponseSchema]?
        ...
        public init(action: String? = nil, countryIsoCode: String? = nil, error: TATErrorResponseSchema? = nil, identifier: String? = nil, isCodAvailable: Bool? = nil, journey: String? = nil, locationDetails: [TATLocationDetailsResponseSchema]? = nil, paymentMode: String? = nil, requestUuid: String? = nil, source: String? = nil, stormbreakerUuid: String? = nil, success: Bool? = nil, toCity: String? = nil, toPincode: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                locationDetails = try container.decode([TATLocationDetailsResponseSchema].self, forKey: .locationDetails)
