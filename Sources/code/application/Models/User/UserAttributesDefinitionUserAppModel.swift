...
public extension ApplicationClient.User {
    /*
        ...
        Used By: User
    */
    class UserAttributesDefinition: Codable {
        ...
        public init(applicationId: String? = nil, createdAt: String? = nil, customerEditable: Bool? = nil, description: String? = nil, encrypted: Bool? = nil, icon: String? = nil, id: String, isLocked: Bool? = nil, isMultiValue: Bool? = nil, masking: AttributeMaskingProperties? = nil, modifiedAt: String? = nil, name: String, orderingChannels: [String]? = nil, pinned: Bool? = nil, pinOrder: Int? = nil, registration: AttributeRegistrationProperties? = nil, slug: String, type: String, validations: [[String: Any]]? = nil) {
