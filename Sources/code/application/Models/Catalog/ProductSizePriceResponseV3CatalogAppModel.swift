...
public extension ApplicationClient.Catalog {
    ...
    class ProductSizePriceResponseV3: Codable {
        ...
        public var buyBox: BuyBoxSchemaV3?
        ...
        public init(articleAssignment: ArticleAssignmentV3? = nil, articleId: String? = nil, buyBox: BuyBoxSchemaV3? = nil, discount: String? = nil, groupedAttributes: [SellerGroupAttributes]? = nil, isCod: Bool? = nil, isGift: Bool? = nil, itemType: String? = nil, longLat: [Double]? = nil, marketplaceAttributes: [MarketPlaceSttributesSchemaV3]? = nil, pincode: Int? = nil, price: ProductStockPriceV3? = nil, pricePerPiece: ProductStockPriceV3? = nil, pricePerUnit: ProductStockUnitPriceV3? = nil, quantity: Int? = nil, returnConfig: ReturnConfigSchemaV3? = nil, seller: SellerV3? = nil, sellerCount: Int? = nil, set: ProductSetV3? = nil, specialBadge: String? = nil, store: StoreV3? = nil, strategyWiseListing: [StrategyWiseListingSchemaV3]? = nil) {
            self.price = price
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                buyBox = try container.decode(BuyBoxSchemaV3.self, forKey: .buyBox)
