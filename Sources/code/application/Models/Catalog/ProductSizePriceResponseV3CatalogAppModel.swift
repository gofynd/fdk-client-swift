...
public extension ApplicationClient.Catalog {
    ...
    class ProductSizePriceResponseV3: Codable {
        ...
        public init(articleAssignment: ArticleAssignmentV3? = nil, articleId: String? = nil, buyBox: BuyBox? = nil, discount: String? = nil, groupedAttributes: [SellerGroupAttributes]? = nil, isCod: Bool? = nil, isGift: Bool? = nil, itemType: String? = nil, longLat: [Double]? = nil, marketplaceAttributes: [MarketPlaceSttributesSchemaV3]? = nil, pincode: Int? = nil, price: ProductStockPriceV3? = nil, pricePerPiece: ProductStockPriceV3? = nil, pricePerUnit: ProductStockUnitPriceV3? = nil, quantity: Int? = nil, returnConfig: ReturnConfigSchemaV3? = nil, seller: SellerV3? = nil, sellerCount: Int? = nil, set: ProductSetV3? = nil, specialBadge: String? = nil, store: StoreV3? = nil, strategyWiseListing: [StrategyWiseListingSchemaV3]? = nil) {
            self.store = store
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                buyBox = try container.decode(BuyBox.self, forKey: .buyBox)
