...
public extension ApplicationClient.Catalog {
    ...
    */
    class StoreDetails: Codable {
        ...
        public init(address: StoreAddressSchema? = nil, company: CompanyStore? = nil, contactNumbers: [SellerPhoneNumber]? = nil, departments: [StoreDepartments]? = nil, manager: StoreManagerSchema? = nil, name: String? = nil, storeCode: String? = nil, timing: [StoreTiming]? = nil, uid: Int? = nil, customJson: [String: Any]? = nil) {
