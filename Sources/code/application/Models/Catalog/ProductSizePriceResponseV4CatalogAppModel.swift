...
public extension ApplicationClient.Catalog {
    ...
    */
    class ProductSizePriceResponseV4: Codable {
        ...
        public var totalAvailableQuantity: Int?
        ...
        public enum CodingKeys: String, CodingKey {
            ...
            case totalAvailableQuantity = "total_available_quantity"
        ...
        public init(articleAssignment: ArticleAssignmentV3? = nil, articleId: String? = nil, deliveryPromise: PromiseSchema? = nil, discount: String? = nil, discountMeta: DiscountMeta? = nil, groupedAttributes: [SellerGroupAttributes]? = nil, inventoryUpdatedOn: String? = nil, isCod: Bool? = nil, isGift: Bool? = nil, isServiceable: Bool? = nil, itemType: String? = nil, longLat: [Double]? = nil, marketplaceAttributes: [MarketPlaceSttributesSchemaV3]? = nil, pincode: String? = nil, price: ProductStockPriceV3? = nil, pricePerPiece: ProductStockPriceV3? = nil, pricePerUnit: ProductStockUnitPriceV3? = nil, quantity: Int? = nil, returnConfig: ReturnConfigSchemaV3? = nil, seller: SellerV3? = nil, sellerCount: Int? = nil, set: ProductSetV3? = nil, specialBadge: String? = nil, store: StoreV3? = nil, strategyWiseListing: [StrategyWiseListingSchemaV3]? = nil, tags: [String]? = nil, totalAvailableQuantity: Int? = nil, trader: [Trader]? = nil, customJson: [String: Any]? = nil) {
            ...
            self.totalAvailableQuantity = totalAvailableQuantity
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                totalAvailableQuantity = try container.decode(Int.self, forKey: .totalAvailableQuantity)
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            try? container.encodeIfPresent(totalAvailableQuantity, forKey: .totalAvailableQuantity)
