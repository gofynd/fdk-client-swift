...
public extension ApplicationClient.Payment {
    ...
    */
    class PaymentStatusUpdateRequest: Codable {
        ...
        public init(aggregator: String, aggregatorOrderId: String? = nil, amount: Int, contact: String? = nil, currency: String? = nil, customerId: String? = nil, deviceId: String? = nil, email: String? = nil, merchantOrderId: String, merchantTransactionId: String? = nil, method: String, orderId: String? = nil, razorpayPaymentId: String? = nil, status: String? = nil, uniqueLinkId: String? = nil, vpa: String? = nil) {
