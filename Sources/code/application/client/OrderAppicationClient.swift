...
public extension ApplicationClient {
    class Order {
        ...
        init(config: ApplicationConfig) {
            ...
            ulrs["updateShipmentExternal1"] = config.domain.appendAsPath("/service/application/order/v1.0/orders/shipments/{shipment_id}/status")
         ...
         * Description:
         **/
        public func updateShipmentExternal1(
            shipmentId: Int,
            body: UpdateShipmentExternalRequest,
            onResponse: @escaping (_ response: UpdateShipmentResponse?, _ error: FDKError?) -> Void
        ) {
            var fullUrl = relativeUrls["updateShipmentExternal1"] ?? ""
