...
public extension ApplicationClient {
    class Order {
        ...
        init(config: ApplicationConfig) {
            ...
            ulrs["updateShipmentStatus2"] = config.domain.appendAsPath("/service/application/order/v1.0/orders/shipments/{shipment_id}/status")
         ...
         * Description:
         **/
        public func updateShipmentStatus2(
            shipmentId: Int,
            body: ShipmentStatusUpdateBody,
            onResponse: @escaping (_ response: ShipmentStatusUpdate?, _ error: FDKError?) -> Void
        ) {
            var fullUrl = relativeUrls["updateShipmentStatus2"] ?? ""
