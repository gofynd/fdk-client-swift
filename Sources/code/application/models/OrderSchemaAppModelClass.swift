...
public extension ApplicationClient {
    ...
    class OrderSchema: Codable {
        ...
        public var userInfo: ShipmentUserInfo1?
        ...
        public init(bagsForReorder: [BagsForReorder]? = nil, breakupValues: [BreakupValues]? = nil, orderCreatedTime: String? = nil, orderId: String? = nil, shipments: [Shipments]? = nil, totalShipmentsInOrder: Int? = nil, userInfo: ShipmentUserInfo1? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                userInfo = try container.decode(ShipmentUserInfo1.self, forKey: .userInfo)
