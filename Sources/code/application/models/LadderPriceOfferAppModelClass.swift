...
public extension ApplicationClient {
    ...
    class LadderPriceOffer: Codable {
        ...
        public init(calculateOn: String? = nil, description: String? = nil, freeGiftItems: [[String: Any]]? = nil, id: String? = nil, offerPrices: [LadderOfferItem]? = nil, offerText: String? = nil, promotionGroup: String? = nil, validTill: String? = nil) {
