...
public extension ApplicationClient {
    ...
    class TATArticlesResponse: Codable {
        ...
        public init(category: TATCategoryRequest? = nil, error: TATErrorSchemaResponse, isCodAvailable: Bool? = nil, manufacturingTime: Int? = nil, manufacturingTimeUnit: String? = nil, promise: TATPromiseResponse? = nil, manufacturingTimeSeconds: String? = nil) {
