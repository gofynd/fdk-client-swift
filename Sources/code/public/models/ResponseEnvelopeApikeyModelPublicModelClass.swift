...
public extension PublicClient {
    ...
    class ResponseEnvelopeApikeyModel: Codable {
        ...
        public var items: ApikeyModel?

        public var payload: ApikeyModel?
        ...
        public init(error: String? = nil, exception: String? = nil, httpStatus: String? = nil, items: ApikeyModel? = nil, message: String? = nil, page: Page? = nil, payload: ApikeyModel? = nil, status: Int? = nil, timestamp: String? = nil, totalTimeTakenInMillis: Int? = nil, traceId: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                items = try container.decode(ApikeyModel.self, forKey: .items)
            ...
            do {
                payload = try container.decode(ApikeyModel.self, forKey: .payload)
