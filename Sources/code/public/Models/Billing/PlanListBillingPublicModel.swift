...
public extension PublicClient.Billing {
    ...
    */
    ...
    class PlanList: Codable {
        ...
        public init(addons: [[String: Any]]? = nil, amount: Int? = nil, approvedBy: String? = nil, channelType: String? = nil, companyIds: [String]? = nil, country: CountryRes? = nil, createdAt: String? = nil, createdBy: String? = nil, creditLine: CreditLine? = nil, currency: String? = nil, currentStatus: String? = nil, description: String? = nil, isActive: Bool? = nil, isTrialPlan: Bool? = nil, isVisible: Bool? = nil, meta: [String: Any]? = nil, modifiedAt: String? = nil, name: String? = nil, oneTimeFees: OneTimeFees? = nil, planGroup: String? = nil, planGroupId: String? = nil, platform: String? = nil, productSuiteId: String? = nil, recurring: Recurring? = nil, tags: [String]? = nil, tagLines: [String]? = nil, taxation: Taxation? = nil, trialPeriod: Int? = nil, type: String? = nil, updatedBy: String? = nil, id: String? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    planGroupId = try container.decode(String.self, forKey: .planGroupId)
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            try? container.encodeIfPresent(planGroupId, forKey: .planGroupId)
