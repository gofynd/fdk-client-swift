...
public extension PublicClient.Billing {
    /*
        Model: TrialPlanDetails
        Used By: Billing
    */

    class TrialPlanDetails: Codable {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    activatedBy = try container.decode(String.self, forKey: .activatedBy)
                ...
                do {
                    country = try container.decode(CountryRes.self, forKey: .country)
