...
public extension PublicClient.Content {
    ...
    */
    ...
    class CompanyLevelMenuItemSchema: Codable {
        ...
        public var child: [CompanyLevelMenuItemSchema]?
        ...
        public init(child: [CompanyLevelMenuItemSchema]? = nil, display: String? = nil, icon: String? = nil, isDisabled: Bool? = nil, link: String? = nil, permissions: [String]? = nil, title: String? = nil, visibleOn: VisibleOnSchema? = nil) {
        ...
        required public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
                ...
                do {
                    child = try container.decode([CompanyLevelMenuItemSchema].self, forKey: .child)
