...
public class Cart {
    ...
    **/
    public func getCartLastModified(
        ...
        onResponse: @escaping (_ response: Any?, _ error: FDKError?) -> Void
    ) {
        APIClient.execute(
            config: config,
            method: "head",
            ...
            onResponse: { (responseData, error, responseCode) in
                if let _ = error, let data = responseData {
                    ...
                    let response = Utility.decode(Any.self, from: data)
                    onResponse(response, nil)
                } else {
                    onResponse(nil, nil)
                }
...
public class User {
    ...
    **/
    public func deleteMobileNumber(
        active: Bool, primary: Bool, verified: Bool, countryCode: String, phone: String,  
    ...
    **/
    public func deleteEmail(
        active: Bool, primary: Bool, verified: Bool, email: String,  
...
public class Configuration {
    ...
    **/
    public func getBasicDetails(
        ...
        onResponse: @escaping (_ response: ApplicationDetailResponse?, _ error: FDKError?) -> Void
    ) {
        APIClient.execute(
            config: config,
            method: "get",
            ...
            onResponse: { (responseData, error, responseCode) in
                if let _ = error, let data = responseData {
                    ...
                    let response = Utility.decode(ApplicationDetailResponse.self, from: data)
                    onResponse(response, nil)
                } else {
                    onResponse(nil, nil)
                }
    ...
    **/
    public func getOrderingStores(
        ...
        APIClient.execute(
            config: config,
            method: "get",
            url: "/service/application/configuration/v1.0/ordering_store/stores",
            query: nil,
            body: nil,
            onResponse: { (responseData, error, responseCode) in
                if let _ = error, let data = responseData {
    ...
    **/
    ...
    /**
    *
    * Summary: Select deployment store
    * Description: Select deployment store.
    **/
    public func (
        ...
        APIClient.execute(
            config: config,
            method: "post",
            url: "/application/current/ordering_store/select",
            query: nil,
            body: body.dictionary,
            onResponse: { (responseData, error, responseCode) in
                if let _ = error, let data = responseData {
