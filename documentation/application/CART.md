...
```swift
cart.addItems(i: i, b: b, buyNow: buyNow, body: body) { (response, error) in
    // Use response
}
```
...
```swift
cart.updateCart(id: id, i: i, b: b, buyNow: buyNow, body: body) { (response, error) in
    // Use response
}
```
...
```swift
cart.checkoutCartV2(buyNow: buyNow, body: body) { (response, error) in
    // Use response
}
```
