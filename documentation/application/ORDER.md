...
```swift
order.updateShipmentStatus1(shipmentId: shipmentId, body: body) { (response, error) in
    // Use response
}
```
...
```swift
order.getOrders1(status: status, pageNo: pageNo, pageSize: pageSize, fromDate: fromDate, toDate: toDate, customMeta: customMeta) { (response, error) in
    // Use response
}
```
...
```swift
order.getOrderById1(orderId: orderId) { (response, error) in
    // Use response
}
```
...
```swift
order.getPosOrderById1(orderId: orderId) { (response, error) in
    // Use response
}
```
...
```swift
order.getShipmentById1(shipmentId: shipmentId) { (response, error) in
    // Use response
}
```
...
```swift
order.getInvoiceByShipmentId1(shipmentId: shipmentId) { (response, error) in
    // Use response
}
```
...
```swift
order.trackShipment1(shipmentId: shipmentId) { (response, error) in
    // Use response
}
```
...
```swift
order.getCustomerDetailsByShipmentId1(orderId: orderId, shipmentId: shipmentId) { (response, error) in
    // Use response
}
```
...
```swift
order.sendOtpToShipmentCustomer1(orderId: orderId, shipmentId: shipmentId) { (response, error) in
    // Use response
}
```
...
```swift
order.verifyOtpShipmentCustomer1(orderId: orderId, shipmentId: shipmentId, body: body) { (response, error) in
    // Use response
}
```
...
```swift
order.getShipmentBagReasons1(shipmentId: shipmentId, bagId: bagId) { (response, error) in
    // Use response
}
```
...
```swift
order.getShipmentReasons1(shipmentId: shipmentId) { (response, error) in
    // Use response
}
```
...
```swift
order.updateShipmentStatus2(shipmentId: shipmentId, body: body) { (response, error) in
    // Use response
}
```
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | products | [[ProductsDataUpdates1](#ProductsDataUpdates1)]? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | status | String? |  yes  |  |
 | shipments | [[ShipmentsRequest1](#ShipmentsRequest1)]? |  yes  |  |
...
---
 ...
 | statuses | [[StatuesRequest1](#StatuesRequest1)]? |  yes  |  |
 | task | Bool? |  yes  |  |
...
---
 ...
 | filters | [[ProductsReasonsFilters1](#ProductsReasonsFilters1)]? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | products | [[ProductsReasons1](#ProductsReasons1)]? |  yes  |  |
 | entities | [[EntitiesReasons1](#EntitiesReasons1)]? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | data | [String: Any]? |  yes  |  |
 | filters | [[ProductsDataUpdatesFilters1](#ProductsDataUpdatesFilters1)]? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | identifier | String |  no  |  |
 | products | [[Products1](#Products1)]? |  yes  |  |
