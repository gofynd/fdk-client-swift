...
```swift
applicationClient.poscart.getCart(id: id, i: i, b: b, p: p, assignCardId: assignCardId, areaCode: areaCode, buyNow: buyNow) { (response, error) in
    // Use response
}
```
...
```swift
applicationClient.poscart.addItems(i: i, b: b, p: p, areaCode: areaCode, buyNow: buyNow, id: id, body: body) { (response, error) in
    // Use response
}
```
...
```swift
applicationClient.poscart.updateCart(id: id, i: i, b: b, p: p, areaCode: areaCode, buyNow: buyNow, body: body) { (response, error) in
    // Use response
}
```
...
```swift
applicationClient.poscart.validateCouponForPayment(id: id, buyNow: buyNow, addressId: addressId, paymentMode: paymentMode, paymentIdentifier: paymentIdentifier, aggregatorName: aggregatorName, merchantCode: merchantCode, iin: iin, network: network, type: type, cardId: cardId) { (response, error) in
    // Use response
}
```
