...
```swift
platformClient.application("<APPLICATION_ID>").cart.updateCartDynamicInjection(id: id, body: body) { (response, error) in
    // Use response
}
```
...
| -------- | ---- | -------- | ----------- | 
| id | String | yes |  |  
| body | CartDynamicInjectionUpdate | yes | Request body |
...
```swift
platformClient.application("<APPLICATION_ID>").cart.removeCartMetaConfig(id: id) { (response, error) in
    // Use response
}
```
...
```swift
platformClient.application("<APPLICATION_ID>").cart.createCartDynamicInjection(body: body) { (response, error) in
    // Use response
}
```
...
| Argument | Type | Required | Description |
| -------- | ---- | -------- | ----------- |
| body | CartDynamicInjectionAdd | yes | Request body |
...
```swift
platformClient.application("<APPLICATION_ID>").cart.getAbandonedCart(userId: userId, pageNo: pageNo, pageSize: pageSize, fromDate: fromDate, toDate: toDate, anonymousCart: anonymousCart, lastId: lastId, sortOn: sortOn) { (response, error) in
    // Use response
}
```
...
```swift
platformClient.application("<APPLICATION_ID>").cart.getAbandonedCartDetails(userId: userId, id: id, i: i, b: b) { (response, error) in
    // Use response
}
```
...
```swift
platformClient.application("<APPLICATION_ID>").cart.addItems(cartId: cartId, b: b, userId: userId, body: body) { (response, error) in
    // Use response
}
```
...
```swift
platformClient.application("<APPLICATION_ID>").cart.updateCart(cartId: cartId, b: b, userId: userId, body: body) { (response, error) in
    // Use response
}
```
...
```swift
platformClient.application("<APPLICATION_ID>").cart.selectPaymentMode(id: id, buyNow: buyNow, body: body) { (response, error) in
    // Use response
}
```
...
```swift
platformClient.application("<APPLICATION_ID>").cart.selectPaymentModeV2(id: id, buyNow: buyNow, body: body) { (response, error) in
    // Use response
}
```
...
---
 ...
 | allowedRefund | Bool? |  yes  |  |
 | userType | String |  no  |  |
 | meta | [Collecttion](#Collecttion)? |  yes  |  |
 | userId | String? |  yes  |  |
 | message | String? |  yes  |  |
 | applyExpiry | String? |  yes  |  |
 | articleLevelDistribution | Bool? |  yes  |  |
 | type | String? |  yes  |  |
 | collection | [String: Any]? |  yes  |  |
 | articleIds | [[Article](#Article)]? |  yes  |  |
 | cartId | String |  no  |  |
