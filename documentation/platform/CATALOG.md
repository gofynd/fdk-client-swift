...
---
 ...
 | isActive | Bool? |  yes  | Indicates if the search words are active. |
 | result | [String: Any]? |  yes  | Search result information. |
 | customJson | [String: Any]? |  yes  | Custom JSON data. |
...
---
 ...
 | results | [[String: Any]]? |  yes  | List of autocomplete results. |
 | customJson | [String: Any]? |  yes  | Custom JSON data. |
