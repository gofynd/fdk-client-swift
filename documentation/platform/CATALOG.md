...
```swift
client.application("<APPLICATION_ID>").catalog.getAllCollections(q: q, scheduleStatus: scheduleStatus, tags: tags, isActive: isActive, pageNo: pageNo, pageSize: pageSize) { (response, error) in
    // Use response
}
```
...
---
 ...
 | type | String |  no  |  |
 | tags | [String]? |  yes  |  |
 | query | [[CollectionQuery1](#CollectionQuery1)]? |  yes  |  |
 | visibleFacetsKeys | [String]? |  yes  |  |
 | allowSort | Bool? |  yes  |  |
 | customJson | [String: Any]? |  yes  |  |
 | name | String |  no  |  |
