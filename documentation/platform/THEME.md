...
```swift
platformClient.application("<APPLICATION_ID>").theme.updateThemeNameV2(themeId: themeId, body: body) { (response, error) in
    // Use response
}
```
...
| body | UpdateThemeNameRequestBodyV2 | yes | Request body |
