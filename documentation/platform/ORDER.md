...
* [getPlatformShipmentReasons1](#getplatformshipmentreasons1)
...
```swift
client.order.getPlatformShipmentReasons1(shipmentId: shipmentId, bagId: bagId, state: state) { (response, error) in
    // Use response
}
```
